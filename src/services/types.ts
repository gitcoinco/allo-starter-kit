...
export interface API {
  indexer: {
    ...
    applicationById: (id: string, opts?: QueryOpts) => Promise<Application | undefined>;
    donations: (query: DonationsQuery) => Promise<Donation[]>;
  };
  allo: {
    createRound: (data: RoundInput, signer: WalletClient) => Promise<RoundCreated>;
    createApplication: (
      data: ApplicationInput,
      signer: WalletClient,
    ) => Promise<ApplicationCreated>;
    getProfile: (signer: WalletClient) => Promise<Address | null>;
    createProfile: (data: ProfileInput, signer: WalletClient) => Promise<ProfileCreated>;
    allocate: (tx: TransactionInput, signer: WalletClient) => Promise<Address | undefined>;
    distribute: () => void;
    sendTransaction: (
